-- 1. Create the ENUM type for account_type
...
CREATE TABLE IF NOT EXISTS public.inventory (
    ...
    inventory_image character varying NOT NULL,
    inventory_thumbnail character varying NOT NULL,
    inventory_price numeric NOT NULL,
    inventory_miles integer NOT NULL,
    inventory_color character varying NOT NULL,
    classification_id integer NOT NULL,
    CONSTRAINT inventory_pkey PRIMARY KEY (inventory_id)
);
-- 3. Create the relationship between inventory and classification
ALTER TABLE public.inventory
ADD CONSTRAINT inventory_classification_id_fkey FOREIGN KEY (classification_id) REFERENCES public.classification (classification_id) ON DELETE RESTRICT;
...
-- 9. Create the messages table for user feedback
CREATE TABLE IF NOT EXISTS public.messages (
    ...
    CONSTRAINT messages_account_id_fkey FOREIGN KEY (account_id) REFERENCES public.account (account_id) ON DELETE CASCADE
);