-- 1. Create account_type lookup table (since SQL Server does not support ENUM)
CREATE TABLE account_type (
    account_type_id INT IDENTITY(1, 1) PRIMARY KEY,
    account_type_name NVARCHAR(20) NOT NULL UNIQUE
);
...
CREATE TABLE inventory (
    ...
    inventory_make NVARCHAR(50) NOT NULL,
    inventory_model NVARCHAR(50) NOT NULL,
    inventory_year INT NOT NULL,
    inventory_description NVARCHAR(MAX) NOT NULL,
    inventory_image NVARCHAR(255) NOT NULL,
    inventory_thumbnail NVARCHAR(255) NOT NULL,
    inventory_price DECIMAL(18, 2) NOT NULL,
    inventory_miles INT NOT NULL,
    inventory_color NVARCHAR(50) NOT NULL,
...
CREATE TABLE account (
    ...
    account_firstname NVARCHAR(50) NOT NULL,
    account_lastname NVARCHAR(50) NOT NULL,
    account_email NVARCHAR(255) NOT NULL,
    account_password NVARCHAR(255) NOT NULL,
    account_type NVARCHAR(20) NOT NULL CHECK (account_type IN ('Client', 'Employee', 'Admin'))
);
-- 5. Insert the classification data
...
-- 7. Update the inventory description
UPDATE inventory
...
-- 8. Update the inventory image and thumbnail
UPDATE inventory
